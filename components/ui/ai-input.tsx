...
export interface MorphPanelProps {
  /** Mesaj gonderildiginde cagrilir. Bos birakilirsa panel yalniz kapanir. */
  onSubmit?: (message: string) => void
  /** Cevap beklenirken girisi kilitler. */
  busy?: boolean
  placeholder?: string
  label?: string
  triggerLabel?: string
    ...
    <div className="flex items-center justify-center" style={{ width: FORM_WIDTH, height: FORM_HEIGHT }}>
      ...
      >
        <FormContext.Provider value={ctx}>
          <DockBar triggerLabel={triggerLabel} busy={busy} />
          <InputForm
            ref={textareaRef}
...
function DockBar({ triggerLabel, busy }: { triggerLabel: string; busy: boolean }) {
...
function InputForm({
  ...
  function handleKeys(e: React.KeyboardEvent<HTMLTextAreaElement>) {
    ...
    // Enter gonderir, Shift+Enter alt satira gecer; ⌘/Ctrl+Enter de calisir.
